...
const pastAppointments: PortalAppointment[] = [
  ...
  appointment({ id: 'past-05', service: 'Sunset Sparkler (20 oz)', days: -135, hour: 16, priceCents: 600, status: 'completed' }),
  appointment({ id: 'past-06', service: 'Rooh Afza Matcha (16 oz)', days: -112, hour: 13, priceCents: 700, status: 'completed' }),
  ...
  appointment({ id: 'past-10', service: 'Brown Sugar Boba Milk Tea (20 oz)', days: -60, hour: 14, priceCents: 700, status: 'completed', mobile: true }),
  appointment({ id: 'past-11', service: 'Milk Cake (Pistachio)', days: -45, hour: 20, priceCents: 700, status: 'completed' }),
...
const upcomingAppointments: PortalAppointment[] = [
  ...
  appointment({ id: 'upcoming-02', service: 'Stuffed Nutella Croissant', days: 1, hour: 12, priceCents: 600, status: 'pending' }),
...
const rewardLedger: RewardEntry[] = [
  ...
  { id: 'ledger-08', entryType: 'purchase', points: 84, description: 'Milk Cake (Pistachio)', earnedAt: isoAt(-45, 20), expiresAt: isoAt(320, 20) },
  { id: 'ledger-09', entryType: 'purchase', points: 84, description: 'Brown Sugar Boba Milk Tea (20 oz)', earnedAt: isoAt(-60, 14), expiresAt: isoAt(305, 14) },
  ...
  { id: 'ledger-12', entryType: 'purchase', points: 84, description: 'Rooh Afza Matcha (16 oz)', earnedAt: isoAt(-112, 13), expiresAt: isoAt(253, 13) },
  { id: 'ledger-13', entryType: 'expiration', points: -40, description: 'Expired Beans', earnedAt: isoAt(-120, 0), expiresAt: null },
  { id: 'ledger-14', entryType: 'purchase', points: 72, description: 'Sunset Sparkler (20 oz)', earnedAt: isoAt(-135, 16), expiresAt: isoAt(230, 16) },
...
const staffAppointments: PortalAppointment[] = [
  ...
  appointment({ id: 'staff-t0-4', service: 'Sunset Sparkler (20 oz)', days: 0, hour: 17, priceCents: 600, status: 'pending', client: 'Reese Talbot', source: 'campaign', newClient: true }),
  appointment({ id: 'staff-t1-1', service: 'Rooh Afza Matcha (16 oz)', days: 1, hour: 10, priceCents: 700, status: 'confirmed', client: 'Devin Park', source: 'website', recoveryMin: 5 }),
  ...
  appointment({ id: 'staff-t3-2', service: 'Brown Sugar Boba Milk Tea (20 oz)', days: 3, hour: 14, priceCents: 700, status: 'confirmed', client: 'Sam Whitfield', mobile: true }),
  appointment({ id: 'staff-t4-1', service: 'Milk Cake (Saffron)', days: 4, hour: 20, priceCents: 700, status: 'pending', client: 'Casey Morgan' }),
  appointment({ id: 'staff-t5-1', service: 'Stuffed Nutella Croissant', days: 5, hour: 12, minute: 30, priceCents: 600, status: 'confirmed', client: 'Morgan Blake' }),
  ...
  appointment({ id: 'staff-t9-2', service: 'Sunset Sparkler (16 oz)', days: 9, hour: 16, priceCents: 600, status: 'confirmed', client: 'Morgan Blake' }),
...
export const DEMO_STAFF: StaffDashboard = {
  ...
  recentPayments: [
    ...
    { id: 'pay-3', clientName: 'Devin Park', itemName: 'Rooh Afza Matcha (16 oz)', method: 'card', amountCents: 700, paidAt: isoAt(-1, 11) },
  ...
  soapNotes: [
    ...
    },
    {
      id: 'soap-3',
      customerId: 'client-3',
      serviceName: 'Brown Sugar Boba Milk Tea (20 oz)',
