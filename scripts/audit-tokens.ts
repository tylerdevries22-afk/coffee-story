...
const ALLOWED = new Map<string, string>([
  ...
  ['packages/integrations/src/catalog-audience.ts', "official connector marks split from catalog.ts"],
  ['packages/integrations/src/catalog-commerce.ts', "official connector marks split from catalog.ts"],
  ['packages/integrations/src/catalog-messaging.ts', "official connector marks split from catalog.ts"],
  ['packages/integrations/src/catalog-planned.ts', "official connector marks split from catalog.ts"],
  ['packages/integrations/src/catalog-platform.ts', "official connector marks split from catalog.ts"],
  ['packages/integrations/src/catalog-publishing.ts', "official connector marks split from catalog.ts"],
