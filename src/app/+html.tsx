    ...
    <html lang="en">
      <head>
        ...
        */}
        ...
        <title>Coffee Story — App Demo</title>
        <meta name="description" content="A working demo of the Coffee Story app." />

        {/* Installable: launches standalone from the home screen. */}
        <link rel="manifest" href="/demo/manifest.webmanifest" />
        <meta name="theme-color" content="#46304E" />
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/demo/icon-180.png" />

        {/* Search engines should index the real site, not the demo shell. */}
