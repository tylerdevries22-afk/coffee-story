 ...
 * literal -- franchisee #1 and #2 at once, not an identity leak. Drift tests
 * pin every file to its tenant folder.
 */
const ALLOWED_TREES = new Map<string, string>([
  ...
  ['apps/hq/lib/actz-', 'ACTZ partner App Factory libs; names the integration, not a shop fixture'],
  ['apps/hq/app/api/integrations/actz/', 'ACTZ partner HTTP surface for App Factory; names the integration, not a shop'],
]);
