...
const DEMO_GUIDES: readonly ProviderGuideView[] = [
  ...
  { provider: 'vercel', title: 'Authorize declared hosted surfaces', ownerRole: 'platform', officialUrl: 'https://vercel.com/docs/rest-api', steps: ['Create a team access token.', 'Choose the owning team.', 'Verify project and environment access.'], lastVerifiedAt: '2026-08-27' },
