...
## Compaction checkpoint — 2026-08-29 16:45:49 (auto)

- branch: `codex/release-readiness-repair`
- working tree clean
- recent commits:
  - 81b73d5 fix: repair hosted release readiness
  - 787d1c5 Merge pull request #49 from tylerdevries22-afk/dev
  - c32dd36 Merge pull request #48 from tylerdevries22-afk/codex/isolated-supabase-ci-branches
  - c3431f8 ci: detach hosted test databases from Git
  - b957be0 ci: isolate hosted Supabase test branches
- recent asks:
...
## Compaction checkpoint — 2026-08-29 17:44:32 (auto)
...
## Compaction checkpoint — 2026-08-29 17:58:03 (auto)
...
- uncommitted (2):
  ...
  - ?? .claude/session-notes.md
- recent commits:
  - adcadc7 wip: durable device refresh secrets (checkpoint, tests pending)
  - ac88864 Merge pull request #51 from tylerdevries22-afk/dev
