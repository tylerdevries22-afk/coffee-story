...
import { useAppTokens, type AppTokens, AppIcon, choiceState } from '@platform/ui';
...
function createStyles({ colors, fonts, spacing }: AppTokens) {
  ...
  safe: { flex: 1, backgroundColor: colors.warm }, header: { minHeight: 58, paddingHorizontal: spacing.sm, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.white, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.ink200 }, back: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' }, headerTitle: { maxWidth: '70%', color: colors.ink900, fontFamily: fonts.sansBold, fontSize: 17 },
  ...
  result: { padding: spacing.md, alignItems: 'center', gap: 3, borderRadius: 12 }, resultPassed: { backgroundColor: colors.successTint }, resultRetry: { backgroundColor: colors.warningTint }, resultTitle: { color: colors.ink900, fontFamily: fonts.sansBold, fontSize: 15 }, resultText: { color: colors.ink700, fontFamily: fonts.sansBold, fontSize: 13 }, submit: { minHeight: 52, paddingHorizontal: spacing.lg, borderRadius: 9, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.ink900 }, submitText: { color: colors.white, fontFamily: fonts.sansBold, fontSize: 15 }, disabled: { opacity: 0.38 }, pressed: { opacity: 0.72 }, message: { flex: 1, padding: spacing.xl, alignItems: 'center', justifyContent: 'center', gap: spacing.md, backgroundColor: colors.warm },
  });
}
