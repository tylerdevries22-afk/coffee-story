...
export const NATIVE_ADMIN_PAGES: Readonly<Record<string, NativeAdminPageConfig>> = {
  '/admin/reviews': {
    ...
    rows: [
      { title: 'Alex Rivera · 5 stars', subtitle: '“Thoughtful care and an unhurried session.”' },
      { title: 'Jamie Lee · 5 stars', subtitle: '“The pressure was exactly right.”' },
    ],
    action: 'Draft reply',
  },
  '/admin/reports': {
    eyebrow: 'Business health', title: 'Reports', summary: 'Review sales, service mix, gratuity, refunds, and upcoming payouts.',
    metrics: [{ label: 'Net sales', value: '$8,742' }, { label: 'Payout', value: '$2,184' }, { label: 'Rebook', value: '71%' }],
    rows: [
      { title: 'Deep Tissue Massage', subtitle: '$3,960 this month' },
      { title: 'Swedish Massage', subtitle: '$2,625 this month' },
      { title: 'Gift cards', subtitle: '$1,140 this month' },
    ],
    action: 'Export report',
  },
  '/admin/talent-acquisition': {
    eyebrow: 'People', title: 'Talent acquisition', summary: 'Review therapist applicants and keep each interview step visible.',
    metrics: [{ label: 'Applicants', value: '12' }, { label: 'Interviews', value: '4' }, { label: 'Offers', value: '1' }],
    rows: [
      { title: 'Mara Bennett', subtitle: 'Licensed therapist · Interview scheduled' },
      { title: 'Devon Brooks', subtitle: 'Licensed therapist · Portfolio review' },
      { title: 'Nina Alvarez', subtitle: 'Massage student · New application' },
    ],
    action: 'Export candidates',
  },
  '/admin/staff': {
    eyebrow: 'People', title: 'Staff', summary: 'Control team access, availability, specialties, and permissions.',
    ...
    rows: [
      ...
      { title: 'Mara Bennett', subtitle: 'Therapist · Schedule and clients' },
    ],
    action: 'Invite staff',
  },
  '/admin/marketing': {
    ...
    rows: [
      { title: 'Monthly reset reminder', subtitle: 'Scheduled · 412 recipients' },
      { title: 'Birthday gift', subtitle: 'Automated · Active' },
      { title: 'First-visit follow-up', subtitle: 'Automated · Active' },
    ],
    action: 'New campaign',
  },
  '/admin/analytics': {
  ...
  '/admin/ads': {
    ...
    rows: [
      { title: 'Massage near Greenwood Village', subtitle: 'Active · $28/day' },
      { title: 'Deep tissue massage', subtitle: 'Active · $18/day' },
    ],
    action: 'New campaign',
  },
  '/admin/settings': {
