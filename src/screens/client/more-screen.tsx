...
import { styles } from './more/information-page';
...
export function MoreScreen() {
  ...
  return (
    ...
    >
      ...
      <PortalProfileCard
        name={portal.profile.fullName || 'Oasis member'}
      ...
      {role === 'admin' || role === 'staff' ? (
        <>
          ...
          <Pressable accessibilityRole="button" onPress={() => openMore('admin')} style={styles.staffCard}>
            <View>
              <Text style={styles.staffTitle}>Open operations directory</Text>
              <Text style={styles.staffSubtitle}>Native staff tools plus every web administration destination</Text>
            </View>
            <Text style={styles.staffArrow}>Open</Text>
          </Pressable>
          <Button label="Open native staff workspace" onPress={() => {
            setStaffTab('today');
            enterStaff();
          }} />
        </>
