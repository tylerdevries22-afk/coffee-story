...
select dblink_connect('package_worker_a', format('dbname=%s user=postgres', current_database()));
select dblink_connect('package_worker_b', format('dbname=%s user=postgres', current_database()));
